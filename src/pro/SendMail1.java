...
class BabyAuthenticator extends Authenticator
{
	...
	getPasswordAuthentication() 
	{
		...
		PasswordAuthentication pa = new 
				...
				("medicare.genesis@gmail.com","Medicaregenesis1");	
...
public class SendMail1 
{
	...
	public static void main(String args1,String args2 ,String args3,String args4) 
	{	
		...
		message.setFrom
		(new InternetAddress("medicare.genesis@gmail.com"));
		
		String date =  args4;
		String email = args1;
		String time = args2;
		String content = args3;
		...
		message.setSubject("Book the slot at "+time+" on "+date);
	      message.setContent("<i style='color : blue'>"+content+"</i>", "text/html" );
